...
%
% 09/14/07 Petr Janata
% 2010.08.20 FB - copied from the autobio/fmri project directory into the
%   private database fmri folder, added "fmri_" prefix to the name to match
%   the convention for fmri analysis helper functions
